...
// when passing an array to a function, it's also necessary to pass its size
// since inside the function the array losses track of its own size (decays to a pointer)
...
int main()
{
    ...
    print_array(fixed_size_array, size_of_fixed);
